...
export default function Index() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, type: 'ai', message: "Hello! I'm your AI assistant. How can I help you with ServiceFlow today?" }
  ]);
  ...
  const generateAIResponse = (userMessage) => {
    const responses = {
      ...
      'vehicle': "For vehicle services, we provide car repair, bike service, roadside assistance, towing, and emergency help. What type of vehicle issue are you facing?",
      'design': "Our design services include interior design, 2D/3D planning, renovation, Vastu consulting, and architecture. Are you looking to redesign your space?",
      ...
      'booking': "To book a service, simply select your service category, choose a provider, pick a time slot, and we'll handle the rest! Would you like me to guide you through the process?",
      'pricing': "Our pricing varies by service type. Home services start from ₹200, vehicle services from ₹300, and design consultations from ₹500. All prices include service guarantee!",
  ...
  const serviceCategories = [
    {
      ...
      services: ["House Cleaning", "Plumbing", "Electrical Work", "Pest Control", "HVAC Services"]
    },
    {
      id: "machine",
      ...
      services: ["AC Repair", "Washing Machine", "Refrigerator", "Microwave", "Water Heater"]
    },
    {
      id: "vehicle",
      ...
      services: ["Car Repair", "Bike Service", "Roadside Assistance", "Towing", "Emergency Help"]
    },
    {
      id: "design",
      ...
      services: ["Interior Design", "2D/3D Planning", "Renovation", "Vastu Consulting", "Architecture"]
    },
    {
      id: "contract",
      ...
      services: ["New Home Construction","Apartment Project","Café Interior Design","Hotel / Bar / Resort Fitout","Office Interior Design","Civil & Structural Work","Tiles & Flooring"]
    },
    {
      id: "ai",
      title: "AI Features",
      ...
      services: ["Vastu Detection", "Design AI", "Smart Predictions", "Personalization", "Automation"]
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Find services available in your area with real-time tracking"
    },
    {
      icon: Star,
    ...
    },
    {
      ...
      description: "UPI, cards, wallets - all payments are encrypted and secure"
    }
  ];

  const siteBackgroundImage = "https://images.unsplash.com/photo-1523419409543-0c1df022bdd1?auto=format&fit=crop&w=1600&q=80";
  ...
  const serviceBackgrounds: Record<string, string> = {
    ...
    machine: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1200&q=80",
    vehicle: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?auto=format&fit=crop&w=1200&q=80",
    design: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=1200&q=80",
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            From home services to vehicle repair, design consultation to AI-powered recommendations. 
            Everything you need, delivered with LiveFlow animations and smart technology.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 max-w-md mx-auto">
            ...
            <Button size="lg" className="px-8" onClick={() => requireLogin(() => { window.location.href = '/book-service'; })}>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From everyday maintenance to specialized design work, we've got you covered with professional services and AI-powered solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {serviceCategories.map((category) => {
            ...
            return (
              <Card key={category.id} className={`group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br ${category.bgGradient} hover:scale-105 cursor-pointer`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 mb-6">
                Get instant vastu analysis, design suggestions, and personalized service recommendations. 
                Our AI learns your preferences to provide better solutions every time.
              </p>
              ...
              <Button className="bg-white text-brand-600 hover:bg-white/90" size="lg" onClick={() => {
                setAiChatModalOpen(true);
                setChatMessages([
                  { id: Date.now(), type: 'ai', message: "Welcome! I’m your AI assistant. I’ll guide you through using ServiceFlow." },
                  { id: Date.now()+1, type: 'ai', message: "You can: 1) Book home, machine, or vehicle services, 2) Launch the Design Studio for 2D/3D plans, 3) Get Vastu analysis and smart recommendations." },
                  { id: Date.now()+2, type: 'ai', message: "Ask me: ‘How do I book a service?’, ‘Open Design Studio’, or ‘Check Vastu’." }
                ]);
              }}>
                Try AI Assistant
              </Button>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="bg-white/20 rounded-lg p-3">
                    <p className="text-sm">🏠 "Help me check vastu for my new apartment"</p>
                  </div>
                  <div className="bg-white/30 rounded-lg p-3 ml-4">
                    <p className="text-sm">✨ I can analyze your floor plan! Upload an image and I'll check vastu compliance and suggest improvements.</p>
                  </div>
                  <div className="bg-white/20 rounded-lg p-3">
                    <p className="text-sm">🎨 "Also suggest interior design ideas"</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Built with cutting-edge technology for seamless service experiences
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="text-center border-0 bg-white/60 backdrop-blur-sm hover:bg-white transition-colors">
      ...
      <footer className="bg-card border-t border-border mt-16">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">ServiceFlow</h3>
              </div>
              <p className="text-muted-foreground mb-4">
                Your complete service solution powered by AI and delivered with care.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Vehicle Services</a></li>
                <li><a href="#" className="hover:text-primary transition-colors">Design & Renovation</a></li>
          ...
          <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
            <p>&copy; 2024 ServiceFlow. All rights reserved. Built with ���️ for better service experiences.</p>
          </div>
        </div>
      </footer>
      ...
      <Dialog open={notificationsOpen} onOpenChange={setNotificationsOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Important updates and recent invoices</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={demoModalOpen} onOpenChange={setDemoModalOpen}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Watch how ServiceFlow revolutionizes home services with AI-powered solutions
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6">
            ...
            <div className="aspect-video bg-black rounded-lg overflow-hidden">
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
                <div className="text-center text-white">
                  ...
                  <p className="text-gray-300 mb-4">Experience ServiceFlow's complete ecosystem</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Complete home maintenance solutions</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4 text-center">
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Smart recommendations & automation</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-6">
              <h4 className="font-semibold mb-4 text-center">What makes ServiceFlow special?</h4>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        <Button className="rounded-full h-12 w-12 p-0 shadow-lg" onClick={() => requireLogin(() => setAiChatModalOpen(true))}>
        ...
        >
          <Button variant="outline" className="rounded-full h-12 w-12 p-0 shadow-lg bg-green-500 text-white hover:bg-green-600">
            <MessageCircle className="h-5 w-5" />
          </Button>
        </a>
      </div>
